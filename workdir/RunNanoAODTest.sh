...
#### Prompt RunC 12_4 data{*} and real MC Run3 campaign
#### > --era Run3 --customise="PhysicsTools/NanoAOD/V10/nano_cff.nanoAOD_customizeV10"

# TAG="nano_default"
# TAG="nano_mod"
# CUSTOMISE_MC="PhysicsTools/NanoAOD/V10/nano_cff.nanoAOD_customizeV10"
# CUSTOMISE_DATA="PhysicsTools/NanoAOD/V10/nano_cff.nanoAOD_customizeV10"
...
if [[ $CMSSW_VERSION == *"CMSSW_12_5_"* ]]; then
  echo "Using CMSSW_12_5_X GT"
  GT_MC_2022="auto:phase1_2022_realistic"
  # GT_MC_2022=122X_mcRun3_2021_realistic_v9
  ...
  # GT_DATA_2022=124X_dataRun3_Prompt_v4
  ...
  echo "Using CMSSW_12_3_X GT"
  GT_MC_2022="auto:phase1_2021_realistic"
  GT_MC_2018=auto:phase1_2018_realistic
  GT_MC_2017=auto:phase1_2017_realistic
  GT_MC_2016=auto:run2_mc
  GT_MC_2016APV=auto:run2_mc
  ...
  GT_DATA_2016=auto:run2_data
  GT_DATA_2016APV=auto:run2_data
elif [[ $CMSSW_VERSION == *"CMSSW_12_2_"* ]]; then
  echo "Using CMSSW_12_2_X GT"
  GT_MC_2022="auto:phase1_2021_realistic"
  GT_MC_2018=auto:phase1_2018_realistic
  GT_MC_2017=auto:phase1_2017_realistic
  GT_MC_2016=auto:run2_mc
...
elif [[ $CMSSW_VERSION == *"CMSSW_10_2_"* ]]; then
  echo "Using CMSSW_10_2_X GT"
  GT_MC_2018=102X_upgrade2018_realistic_v21 #NanoAODv7 GT
  GT_MC_2017=102X_mc2017_realistic_v8 #NanoAODv7 GT
  GT_MC_2016=102X_mcRun2_asymptotic_v8 #NanoAODv7 GT
  GT_DATA_2018=102X_dataRun2_Prompt_v16 # For 2018 Period D only
  GT_DATA_2017=102X_dataRun2_v13
  GT_DATA_2016=102X_dataRun2_v13
else
